...
{
    class MarksmanStoryline
    {
        public MarksmanStoryline()
        {
            Marksman player = new Marksman();
            Battler battler = new Battler();
            Goar goar = new Goar();
            DoomTheConqueror doomTheConqueror = new DoomTheConqueror();
            Console.WriteLine("Well done, ");
            Console.WriteLine("You choose Marksman's Gun to fullfil your power");
            Console.WriteLine("The spirits of the Marksmans will help you finish your journey");
            Console.Read();
