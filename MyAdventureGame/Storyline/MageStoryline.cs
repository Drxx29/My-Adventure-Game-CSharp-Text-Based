...
namespace MyAdventureGame
{
    class MageStoryline
    {
        public MageStoryline()
        {
            ...
            Console.WriteLine("You choose Mage's Scroll to fullfil your power");
            Console.WriteLine("The spirits of the Mages will help you finish your journey");
            Console.Read();
