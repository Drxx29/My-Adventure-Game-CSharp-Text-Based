...
{
    class AssassinStoryline
    {
        public AssassinStoryline()
        {
            ...
            Console.WriteLine("You choose Assassin's Blade to fullfil your power");
            Console.WriteLine("The spirits of the Assassins will help you finish your journey");
            Console.Read();
...
}//else{Console.WriteLine("Well, comeback again when you're ready...");Console.Read(); }